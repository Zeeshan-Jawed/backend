...
public class SubCategoryController {
    ...
    @PostMapping(value = "/")
    public String saveAppUSer(@RequestBody SubCategoryDTO subCategoryDTO){
        return subCategoryService.save(subCategoryDTO);
    }
    @GetMapping(value="/")
    public Set<SubCategory> getAppUser(){
    ...
    @PutMapping("/{id}")
    public String updateAppUser(@PathVariable("id") Long id , @RequestBody SubCategoryDTO subCategoryDTO ){
